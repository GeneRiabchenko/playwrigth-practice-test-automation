...
public class ScenarioTracingFixtures {
    ...
    public void setupTrace(){
        PlaywrightCucumberFixtures.getBrowserContext().tracing().start(new Tracing.StartOptions()
                .setScreenshots(true)
                .setSnapshots(true)
                .setSources(true));
    }
    ...
    public void recordTrace(Scenario scenario){
        ...
        PlaywrightCucumberFixtures.getBrowserContext().tracing().stop(new Tracing.StopOptions()
